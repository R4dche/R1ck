...
for (let i = 0; i < array.length; i++) {
  ...
  maxNumberAndReset = array.map(function (elem) {return elem === maxNumberInArray ? elem : 0});
};
...
console.log("Max number and reset: " + maxNumberAndReset);
